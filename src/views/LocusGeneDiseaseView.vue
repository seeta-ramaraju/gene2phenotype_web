...
<template>
  <div class="container px-5 py-3" style="min-height: 60vh">
    <div class="d-flex justify-content-center" v-if="isDataLoading" style="margin-top: 250px; margin-bottom: 250px">
    ...
    <div v-if="locusGeneDiseaseData">
      ...
      <table class="table table-borderless my-3">
        <tbody>
          ...
          <tr class="align-middle">
            ...
            <td class="w-75">
              <p v-if="locusGeneDiseaseData.cross_cutting_modifier &&
      ...
      locusGeneDiseaseData.cross_cutting_modifier
        ...
        .join(", ")
          ...
          <tr>
            ...
            <td class="w-75">
              <table class="table table-bordered" v-if="locusGeneDiseaseData.variant_type &&
      ...
      ">
                ...
                <tbody>
                  <tr v-for="item in locusGeneDiseaseData.variant_type">
                    <td style="width: 20%">
                      <a v-bind:href="`http://www.sequenceontology.org/browser/current_release/term/${item.accession}`"
                        style="text-decoration: none" v-if="item.accession" target="_blank">
                        {{ item.accession }}
                      </a>
                    </td>
                    <td style="width: 80%">
          ...
          <tr>
            ...
            <td class="w-75">
              <table class="table table-bordered" v-if="locusGeneDiseaseData.variant_consequence &&
      ...
      ">
          ...
          <tr>
            ...
            <td class="w-75">
              <table class="table table-bordered" v-if="locusGeneDiseaseData.molecular_mechanism &&
      ...
      ">
          ...
          <tr>
            ...
            <td class="w-75">
              <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapsibleTable"
                aria-expanded="false" aria-controls="collapsibleTable">
                View phenotypes
              </button>
              <div class="collapse" id="collapsibleTable">
                <table class="table table-bordered"
                  v-if="locusGeneDiseaseData.phenotypes && locusGeneDiseaseData.phenotypes.length > 0">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    <tr v-for="item in locusGeneDiseaseData.phenotypes" :key="item.accession">
                      <td style="width: 20%">
                        <a :href="`https://hpo.jax.org/app/browse/term/${item.accession}`" style="text-decoration: none"
                          v-if="item.accession" target="_blank">
                          {{ item.accession }}
                        </a>
                      </td>
                      <td style="width: 80%">
      ...
      fontWeight: 'bold',
          ...
          <tr>
            ...
            <td class="w-75">
              <table class="table table-bordered" v-if="locusGeneDiseaseData.publications &&
      ...
      ">
                ...
                <tbody>
                  <tr v-for="item in locusGeneDiseaseData.publications">
                    <td style="width: 10%">
                      <a v-bind:href="`https://europepmc.org/article/MED/${item.publication.pmid}`"
                        style="text-decoration: none" v-if="item.publication.pmid" target="_blank">
          ...
          <tr class="align-middle">
            ...
            <td class="w-75">
              <span v-if="locusGeneDiseaseData.panels &&
      ...
      ">
                <span v-for="(item, index) in locusGeneDiseaseData.panels">
                  <span v-if="index < locusGeneDiseaseData.panels.length - 1">
                    <router-link :to="`/panel/${item.name}`" style="text-decoration: none">
                      {{ item.description ? item.description : item.name }}
                    </router-link>
                    ,
                  </span>
                  <router-link :to="`/panel/${item.name}`" v-else style="text-decoration: none">
                    {{ item.description ? item.description : item.name }}
                  </router-link>
                </span>
              </span>
          ...
          <tr class="align-middle">
            ...
            <td>
              <router-link :to="`/gene/${locusGeneDiseaseData.locus.gene_symbol}`"
                v-if="locusGeneDiseaseData.locus.gene_symbol" style="text-decoration: none">
          ...
          <tr class="align-middle">
            ...
            <td>
              <p v-if="locusGeneDiseaseData.locus.synonyms &&
      ...
      ">
          ...
          <tr class="align-middle">
            ...
            <td>
              <a v-bind:href="`https://www.omim.org/entry/${locusGeneDiseaseData.locus.ids.OMIM}`"
                style="text-decoration: none" v-if="locusGeneDiseaseData.locus.ids.OMIM" target="_blank">
          ...
          <tr class="align-middle">
            ...
            <td>
              <a v-bind:href="`https://www.ensembl.org/Homo_sapiens/Gene?g=${locusGeneDiseaseData.locus.ids.Ensembl}`"
                style="text-decoration: none" v-if="locusGeneDiseaseData.locus.ids.Ensembl" target="_blank">
          ...
          <tr class="align-middle">
            ...
            <td>
              <a v-bind:href="`https://www.genenames.org/data/gene-symbol-report/#!/hgnc_id/${locusGeneDiseaseData.locus.ids.HGNC}`"
                style="text-decoration: none" v-if="locusGeneDiseaseData.locus.ids.HGNC" target="_blank">
          ...
          <tr class="align-middle">
            ...
            <td>
              <router-link :to="`/disease/${locusGeneDiseaseData.disease.name}`"
                v-if="locusGeneDiseaseData.disease.name" style="text-decoration: none">
                {{ locusGeneDiseaseData.disease.name }}
              </router-link>
              <p v-else class="text-muted">Not Available</p>
            </td>
          ...
          <tr class="align-middle">
            ...
            <td>
              <a v-bind:href="`https://monarchinitiative.org/${locusGeneDiseaseData.disease.ontology_terms[0].accession}`"
                style="text-decoration: none" v-if="locusGeneDiseaseData.disease.ontology_terms &&
      ...
      " target="_blank">
          ...
          <tr class="align-middle">
            ...
            <td>
              <a v-bind:href="`https://www.omim.org/entry/${locusGeneDiseaseData.disease.mim}`"
                style="text-decoration: none" v-if="locusGeneDiseaseData.disease.mim" target="_blank">
