...
export const HELP_TEXT = {
  ALLELIC_REQUIREMENT:
    "Required genotype. G2P uses synonyms of the HPO mode of inheritance terminology is used as many of the disorders described are de novo.",
  VARIANT_CONSEQUENCE:
    "The consequence of the reported variants at the protein (for protein-coding genes) or the RNA (for non-protein coding genes), per allele.",
  VARIANT_TYPE:
  ...
  CONFIDENCE: "Confidence the assosiation is real, based on available evidence",
